...
// ── Local types (aligned to DB schema) ─────────────────────────────────────
...
const BlogPage = () => {
  ...
  const fetchSingleBlog = useCallback(async () => {
    ...
    try {
      setPageLoading(true);
      const { data } = await axios.get<{ blog: BlogDetail; author: Author }>(
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
                ...
                {/* ✅ Fixed: was blog.createdAt — now correctly blog.create_at */}
                {blog.create_at && (
                  <span>
      ...
      {/* ── Comments ── */}
      <section aria-label="Comments" className="max-w-3xl mx-auto px-6 pb-20">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-baseline justify-between gap-2">
                      ...
                      {/* ✅ Fixed: c.create_at used consistently throughout */}
                      <time
